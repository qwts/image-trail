...
const sourcePath = path.join(rootDir, 'image-url-token-editor.bookmarklet.src', 'image-url-token-editor.bookmarklet.src.js');
...
const sourceFileName = path.relative(rootDir, sourcePath).split(path.sep).join('/');
...
const bookmarkletCodeWithoutSourceMap = minifyResult.code.replace(/\n*\/\/# sourceMappingURL=.*$/u, '');

const inlineSourceMap = Buffer.from(minifyResult.map, 'utf8').toString('base64');
