...
6. Change the template match mode and toggle Hide excluded fields.
7. Confirm the settings persist after closing/reopening the panel on the same hostname.
8. Clear the template.
9. Confirm it disappears from Settings and hidden fields are no longer hidden by that template.
