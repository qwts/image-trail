> Originally moved from `docs/2026-06-20-regression-fixes.md` during issue
...
- Draft PR: https://github.com/qwts/image-trail/pull/68
- Base branch: `codex/dev` (historical; development is now trunk-based on `main`)
