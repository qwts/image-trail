...
extension/src/
  ...
  ui/
    ...
    components/
      ...
      settings-view.ts
      display-settings-view.ts
      privacy-settings-view.ts
      automation-settings-view.ts
      maintenance-settings-view.ts
      url-learning-settings-view.ts
...
`settings-view.ts` is the Settings composition boundary: it owns group ordering,
collapsible-group state, and utility-child placement. Display, Privacy,
Automation, Maintenance, and URL-learning DOM/event wiring lives in the matching
typed group module so setting persistence remains behind the shared panel action
contract rather than inside the rendering orchestrator.
...
extension/dist/
  ...
  ui/
    ...
    components/
      ...
      settings-view.js
      display-settings-view.js
      privacy-settings-view.js
      automation-settings-view.js
      maintenance-settings-view.js
      url-learning-settings-view.js
...
- Use `bookmarks` in new extension code even if the bookmarklet called them `favorites`; keep `favorites` only as historical terminology when comparing old behavior.
