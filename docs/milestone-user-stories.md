...
As a user, I want to recover older encrypted records and move data between installs without exposing plaintext. This milestone adds recall/decrypt flows, encrypted import/export, key wrapping, and encrypted download envelopes.
