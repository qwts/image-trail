export interface ImageDisplayRecord {
  ...
  readonly originalBlobId?: string;
  readonly captureStatus?: import('./image/image-metadata.js').CaptureStatus;
  readonly captureError?: import('./image/image-metadata.js').CaptureFailureReason;
