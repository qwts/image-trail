...
**Milestone:** <!-- Example: M03: URL Parser, Field Model, And Navigation Core -->  
**Order:** <!-- Example: 3 -->  
**Type:** <!-- Example: Port / refactor -->
...
- **Change isolation:** Volatile browser APIs, storage formats, permission prompts, LLM endpoints, and future React/Vite rendering should sit behind adapters.
